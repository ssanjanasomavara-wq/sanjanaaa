...
export default function Games() {
  ...
  function handleSignOut() { router.replace('/'); }
    ...
    <div className="site-root">
      <div className="site">
        ...
        <main style={{ padding: 18 }}>
          <h1>Games</h1>
          <p>Relaxing mini-games and playful prototypes. Click any tile to open a game.</p>

          <div className="games-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 12, marginTop: 18 }}>
            <Link href="/games/mindful-puzzle" legacyBehavior>
              <a className="game-tile" role="listitem" style={{ display: 'block', padding: 16, background: '#fff', borderRadius: 12, textDecoration: 'none', color: '#222', boxShadow: '0 6px 18px rgba(20,40,60,0.06)' }}>
                ...
                <div style={{ fontSize: 12, color: '#617489', marginTop: 6 }}>Quick mindful check-ins and puzzles</div>
              </a>
            </Link>

            {/* Add more game tiles below in the same pattern */}
            {/* Example:
            <Link href="/games/another-game" legacyBehavior>
              <a className="game-tile">...tile content...</a>
            </Link>
            */}
          </div>
        </main>
